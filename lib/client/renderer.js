...
function init (client, d3) {
  ...
  function prepareArc(treatment, radius) {
    ...
    if (treatment.carbs) { rWhite = radius.R1; }
    if (treatment.insulin < 0) { rWhite = radius.R1; }
    if (treatment.insulin > 0) { rBlue = radius.R1; }
    var arc_data = [
    ...
    // negative boluses should be drawn like carbs
    ...
    // only label boluses larger than 0.1 U, as 0.1U boluses are used to represent temp basals
