...
function configure (app, wares, pumphistory) {
    ...
    api.get('/pumphistory/', function(req, res) {
        pumphistory.list(function (err, profiles) {
    ...
    function config_authed (app, api, wares, pumphistory) {
        ...
        api.post('/pumphistory/', /*TODO: auth disabled for quick UI testing... wares.verifyAuthorization, */ function(req, res) {
            var obj = req.body;
            pumphistory.create(obj, function (err, created) {
                if (err)
